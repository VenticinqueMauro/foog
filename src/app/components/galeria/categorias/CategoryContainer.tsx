            ...
            <div className="flex items-center justify-center flex-grow">
                {categoryItems.map((item, i) => (
                    ...
                    >
                        ...
                        />
                        <p className="absolute top-0 left-0 flex items-end gap-4 p-3 mt-4 text-xl font-semibold capitalize group-hover:bg-black/70 group-hover:rounded-r-[6px] pr-8 group-hover:border-[#d6fb41] group-hover:border-t-2 group-hover:border-b-2 group-hover:border-r-2 ">
