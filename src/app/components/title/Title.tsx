...
export default function Title({ title }: { title: string }) {
    ...
    return (
        <h1 className={`${robotoCondensed.className} text-4xl md:text-5xl lg:text-6xl font-bold text-center capitalize text-[#ACAA9E]`} style={{textShadow: "0px 0px 5px #161616"}}>{title}</h1>
    )
}