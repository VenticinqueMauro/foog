...
export default function ZoomButton({categoryName}: Props) {
    return (
        <Link href={`/galeria/${categoryName}`} className="absolute w-0 h-0 transition-all transform -translate-x-1/2 -translate-y-1/2 rounded-full group:duration-300 group-hover:w-32 group-hover:h-32 bg-black/40 top-1/2 left-1/2 cristal">
