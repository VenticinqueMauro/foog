        ...
        <div className="w-60 xl:hidden">
            <Listbox value={selected} onChange={setSelected}>
                <div className="relative mt-1">
                    <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-black border rounded shadow-md cursor-default border-zinc-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 sm:text-sm">
                    ...
                    >
                        <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base rounded bg-zinc-100 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                            {/* <Listbox.Option
                                ...
                                value="All Projects"
                                onClick={() => handleFilterByFolder("allProjects")}
                            >
                                {({ selected }) => (
                                    <>
                                        <span
