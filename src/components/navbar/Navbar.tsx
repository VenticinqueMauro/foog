...
const Sidebar = dynamic(() => import("./menu/Sidebar"), { ssr: false });
...
function Navbar() {
    ...
    return (
        <>
            <nav className="fixed top-0 left-0 z-20 flex flex-row-reverse items-center justify-between w-full px-6 py-3 text-zinc-100 md:px-10 lg:flex-row ">
                <MenuHamburguesa />
                <Logo />
